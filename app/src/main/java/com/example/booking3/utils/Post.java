...
//"PASS":"VALOR";
    ...
    private void conectaPost(Map<String,String> dataToSend, String
            pagina) {
        try {
...
// Recupero un lector (corriente de datos de entrada), es decir, del Servidor hacia a mí.
            ...
            Log.e("log_tag_1", "Error in http connection " + e.toString());
        } finally {
        }
    }
...
// Recupero un lector (corriente de datos de entrada), es decir, del Servidor hacia a mí.
            ...
            Log.e("log_tag_2", "Error in http connection " + e.toString());
        } finally {
            try {
                if(con!=null)
                {
                ...
                Log.e("log_tag_3", "Error in http connection " + e.toString());
            }
        }
    }
    private JSONArray getRespuestaPostEnJson() {
        ...
        try {
            ...
            Log.e("log_tag_4", "Cadena JSon " + respuesta);
        } catch (Exception e) {
            Log.e("log_tag_5", "Error converting result " + e.toString());
        }finally {
            try {
                if(writer!=null) {
                    writer.close();
                ...
                Log.e("log_tag_6", "Error in http connection " + e.toString());
            }
            Log.e("log_tag_7", "Cadena jArray " + jArray);
            return jArray;
        }
    }
